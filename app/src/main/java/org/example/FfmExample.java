...
public class FfmExample {
  ...
  public static int calculate(Input input) throws Throwable {
    try (Arena arena = Arena.ofConfined()) {
      ...
      inputLayout
          .varHandle(MemoryLayout.PathElement.groupElement("op"))
      ...
      FunctionDescriptor calculateFuncDesc =
          FunctionDescriptor.of(ValueLayout.JAVA_INT, inputLayout);
